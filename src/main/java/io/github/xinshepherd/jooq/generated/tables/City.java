...
import io.github.xinshepherd.jooq.generated.tables.records.CityRecord;
...
public class City extends TableImpl<CityRecord> {
    ...
    private static final long serialVersionUID = 2415584;
     ...
     */
    public final TableField<CityRecord, String> NAME = createField(DSL.name("Name"), org.jooq.impl.SQLDataType.CHAR(35).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");

    /**
     * The column <code>world.city.CountryCode</code>.
     */
    public final TableField<CityRecord, String> COUNTRYCODE = createField(DSL.name("CountryCode"), org.jooq.impl.SQLDataType.CHAR(3).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");

    /**
     * The column <code>world.city.District</code>.
     */
    public final TableField<CityRecord, String> DISTRICT = createField(DSL.name("District"), org.jooq.impl.SQLDataType.CHAR(20).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");

    /**
     * The column <code>world.city.Population</code>.
     */
    public final TableField<CityRecord, Integer> POPULATION = createField(DSL.name("Population"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");
